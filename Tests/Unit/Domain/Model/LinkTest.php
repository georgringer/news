 ...
 */
class Tx_News2_Tests_Unit_Domain_Model_LinkTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	...
	protected function setUp() {
		$this->linkDomainModelInstance = $this->objectManager->get('Tx_News2_Domain_Model_Link');
	}
