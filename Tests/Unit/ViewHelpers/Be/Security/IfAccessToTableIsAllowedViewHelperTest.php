...
class IfAccessToTableIsAllowedViewHelperTest extends \TYPO3\CMS\Fluid\Tests\Unit\ViewHelpers\ViewHelperBaseTestcase
{
    ...
    public function setUp()
    {
        ...
        $GLOBALS['BE_USER'] = $this->getMock('TYPO3\\CMS\\Core\\Authentication\\BackendUserAuthentication', ['dummy']);

        $this->viewHelper = $this->getAccessibleMock('GeorgRinger\\News\\ViewHelpers\\Be\\Security\\IfAccessToTableIsAllowedViewHelper', ['renderThenChild', 'renderElseChild']);
    ...
    {
        $backup = [$GLOBALS['BE_USER']->user['admin'], $GLOBALS['BE_USER']->groupData['tables_modify']];
        $GLOBALS['BE_USER']->user['admin'] = 0;
