...
//		$settingsService->_set('settings', array('disqusLang' => $language));
		$settingsService->expects($this->any())
			->method('getSettings')
			->will($this->returnValue(array('disqusLang' => $language)));

//		$settingsService = new Tx_News_Service_SettingsService();
//		$settingsService->setSettings(array('disqusLang' => $language));
		...
		$this->assertEquals($expectedCode, $actualResult, $expectedCode . '===========' . $actualResult);
	}
