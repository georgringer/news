 ...
 */
class Tx_News2_Service_Import_TTNewsImportService implements Tx_News2_Service_Import_ImportServiceInterface, t3lib_Singleton {
	...
	public function createImportArray($offset = 0, $limit = 50) {
		$importArray = array();
