...
class LinkViewHelper extends \TYPO3\CMS\Fluid\ViewHelpers\Link\PageViewHelper
{
     ...
     * @return string link
     */
    public function render(\GeorgRinger\News\Domain\Model\News $newsItem, array $settings = [], $uriOnly = false, $configuration = [], $content = '')
    {
     ...
     * @return array
     */
    protected function getLinkToNewsItem(\GeorgRinger\News\Domain\Model\News $newsItem, $tsSettings, array $configuration = [])
    {
