...
class NewsController extends NewsBaseController
{
     ...
     * @return void
     */
    public function searchFormAction(\GeorgRinger\News\Domain\Model\Dto\Search $search = null, array $overwriteDemand = [])
    {
        $demand = $this->createDemandObjectFromSettings($this->settings);
        $demand->setActionAndClass(__METHOD__, __CLASS__);
     ...
     * @return void
     */
    public function searchResultAction(\GeorgRinger\News\Domain\Model\Dto\Search $search = null, array $overwriteDemand = [])
    {
        $demand = $this->createDemandObjectFromSettings($this->settings);
        $demand->setActionAndClass(__METHOD__, __CLASS__);
