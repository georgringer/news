...
class PageLayoutView
{
        ...
        if ($singleNewsRecord > 0) {
            ...
            if (is_array($newsRecord)) {
                ...
                if (is_array($pageRecord)) {
                    $iconPage = IconUtility::getSpriteIconForRecord('pages', $pageRecord, ['title' => 'Uid: '.$pageRecord['uid']]);
                    $iconNews = IconUtility::getSpriteIconForRecord('tx_news_domain_model_news', $newsRecord, ['title' => 'Uid: '.$newsRecord['uid']]);
    ...
    public function getDetailPidSetting()
    {
        ...
        if ($detailPid > 0) {
            ...
            $this->tableData[] = [$this->getLanguageService()->sL(self::LLPATH.'flexforms_additional.detailPid'), $content];
        }
    }
    ...
    public function getListPidSetting()
    {
        ...
        if ($listPid > 0) {
            ...
            $this->tableData[] = [$this->getLanguageService()->sL(self::LLPATH.'flexforms_additional.listPid'), $content];
        }
    }
    ...
    public function getPageRecordData($detailPid)
    {
        ...
        if (is_array($pageRecord)) {
            $data = IconUtility::getSpriteIconForRecord('pages', $pageRecord, ['title' => 'Uid: '.$pageRecord['uid']])
    ...
    public function getOffsetLimitSettings()
    {
        ...
        if ($offset) {
            $this->tableData[] = [$this->getLanguageService()->sL(self::LLPATH.'flexforms_additional.offset'), $offset];
        }
        if ($limit) {
            $this->tableData[] = [$this->getLanguageService()->sL(self::LLPATH.'flexforms_additional.limit'), $limit];
        }
        if ($hidePagination) {
            $this->tableData[] = [$this->getLanguageService()->sL(self::LLPATH.'flexforms_additional.hidePagination'), null];
        }
    }
    ...
    public function getOverrideDemandSettings()
    {
        ...
        if ($field == 1) {
            $this->tableData[] = [$this->getLanguageService()->sL(
