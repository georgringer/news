...
$tx_news_domain_model_media = [
    ...
    'columns' => [
        ...
        'type' => [
            ...
            'config'    => [
                'type'  => 'select',
                'items' => [
                    [$ll.'tx_news_domain_model_media.type.I.0', '0', \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('news').'Resources/Public/Icons/media_type_image.png'],
                    [$ll.'tx_news_domain_model_media.type.I.1', '1', \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('news').'Resources/Public/Icons/media_type_multimedia.png'],
                ],
                'size'     => 1,
                'maxitems' => 1,
            ],
    ...
    'types' => [
        // Image
        '0' => ['showitem' => '--palette--;;paletteCore,image;;paletteWidthHeight,caption,title;;paletteAlt,copyright,description;;;richtext::rte_transform[flag=rte_disabled|mode=ts_css],'],
