...
^^^^^^^^^^^^^^^^^^^^^^^
This is the 1st version which supports the upcoming TYPO3 9 version and version 8 LTS.
...
.. Important::
        ...
        Support for version 7.6 has been dropped. With October 2018 7.6 wil have reached end of life.
